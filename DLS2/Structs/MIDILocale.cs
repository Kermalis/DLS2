	...
	public sealed class MIDILocale
	{
		...
		public byte CC32
		{
			...
			set
			{
				if (value > 0x7F)
				{
					throw new ArgumentOutOfRangeException(nameof(value), value, "Invalid CC32 value");
				}
		...
		public byte CC0
		{
			...
			set
			{
				if (value > 0x7F)
				{
					throw new ArgumentOutOfRangeException(nameof(value), value, "Invalid CC0 value");
				}
		...
		public byte Instrument
		{
			...
			set
			{
				if (value > 0x7F)
				{
					throw new ArgumentOutOfRangeException(nameof(value), value, "Invalid instrument number");
				}
		...
		{
			writer.WriteUInt32(Bank_Raw);
			writer.WriteUInt32(Instrument_Raw);
		}
	}
}
