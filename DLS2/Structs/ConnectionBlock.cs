...
namespace Kermalis.DLS2
{
	public sealed class Level1ArticulatorConnectionBlock
	{
		...
		internal void Write(EndianBinaryWriter writer)
		{
			...
			writer.WriteEnum(Control);
			writer.WriteEnum(Destination);
			writer.WriteEnum(Transform);
	...
	public sealed class Level2ArticulatorConnectionBlock
	{
		...
		public Level2ArticulatorTransform TransformSource
		{
			...
			set
			{
				...
				{
					throw new ArgumentOutOfRangeException(nameof(value), value, "Invalid Level2ArticulatorTransform");
				}
		...
		internal void Write(EndianBinaryWriter writer)
		{
			...
			writer.WriteEnum(Control);
			writer.WriteEnum(Destination);
			writer.WriteUInt16(Transform_Raw);
			writer.WriteInt32(Scale);
		}
	}
}
